...
public abstract class WebSocketClient implements Runnable, WebSocketListener {
	 ...
	 *             If <var>draft</var> is <code>WebSocketDraft.AUTO</code>
	 */
			...
			conn.socketChannel().write(
					new ByteBuffer[] {
							ByteBuffer.wrap(request
									.getBytes(WebSocket.UTF8_CHARSET)),
	 ...
	 * 
	 * @param conn
	 *            The {@link WebSocket} instance who's handshake has been
	 *            recieved. In the case of <tt>WebSocketClient</tt>, this.conn
	 *            == conn.
	 * @param handshake
	 *            The entire UTF-8 decoded handshake from the connection.
	 * @return <var>true</var> if <var>handshake</var> is a valid WebSocket
	 *         server handshake, <var>false</var> otherwise.
	 * @throws IOException
	 *             When socket related I/O errors occur.
